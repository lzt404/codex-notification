...
Expanded assets page pattern: `https://github.com/lzt404/codex-notification/releases/expanded_assets/<resolved-tag>`
Optional latest release API: `https://api.github.com/repos/lzt404/codex-notification/releases/latest`
